...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      // hiding keyboard when tapped anywhere in the screen else except keyboard
      onTap: () => FocusScope.of(context).unfocus(),
      // will pop is used to go back means it pops the screen from stack
      child: WillPopScope(
        // if search is on and back button is tapped then close search
